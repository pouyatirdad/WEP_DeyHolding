...
namespace Road.Infrastructure.Helpers
{
    public class Email
    {
        ...
        public static async Task SendEmail(EmailFormModel emailForm)
        {
            ...
            message.From = new MailAddress(appSettings["Email"]);  // replace with valid value
            ...
            using (var smtp = new SmtpClient())
            {
                ...
                {
                    UserName = appSettings["Email"], // replace with valid value
                    Password = appSettings["Password"] // replace with valid value
                };
